...
/**
 * Base class for simple domain objects that allow CRUD operations via a Content
 * Provider. Cruddable provides a number of non-static inner classes that allow
 * persisting a number of different basic types.
 * 
 * Contains a default
 * 
 * <pre>
 ...
 * </pre>
 * 
 * implementation that will work correctly if you only add members that are
 * derived of
 * 
 * <pre>
 * <code>CrudValue<code><pre>.
 * 
...
public abstract class Cruddable implements Serializable {
	...
	public abstract class CrudValue<T> implements Serializable {
		...
		public abstract void set(final String s);
	...
	public abstract class CrudNotNullableValue<T> extends CrudValue<T> {
		public CrudNotNullableValue(final String dbFieldName) {
			super(dbFieldName);
		}
	...
	public abstract class CrudNotNullableObjectValue<T> extends
			CrudNotNullableValue<T> {
		protected T t;

		public CrudNotNullableObjectValue(final String dbFieldName) {
			super(dbFieldName);
		}
		...
		public void set(final T t) {
			if (t == null)
				throw new NullPointerException("Attempt to set null on "
	...
	public class CrudBoolean extends CrudNotNullableValue<Boolean> {
		...
		public CrudBoolean(final String dbFieldName) {
			super(dbFieldName);
		}
		...
		@Override
		public void set(final Boolean t) {
			this.t = t;
		}

		public void setBoolean(final boolean t) {
			this.t = t;
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.getInt(offset + index) != 0;
		}

		@Override
		protected void addToContentValues(final ContentValues values) {
			values.put(dbFieldName, t ? 1 : 0);
		}
	...
	public class CrudShort extends CrudNotNullableValue<Short> {
		...
		public CrudShort(final String dbFieldName) {
			super(dbFieldName);
		}
		...
		@Override
		public void set(final Short t) {
			this.t = t;
		}

		public void setShort(final short t) {
			this.t = t;
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.getShort(offset + index);
		}

		@Override
		protected void addToContentValues(final ContentValues values) {
			values.put(dbFieldName, t);
		}
	...
	public class CrudInteger extends CrudNotNullableValue<Integer> {
		...
		public CrudInteger(final String dbFieldName) {
			super(dbFieldName);
		}
		...
		@Override
		public void set(final Integer t) {
			this.t = t;
		}

		public void setInt(final int t) {
			this.t = t;
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.getInt(offset + index);
		}
	...
	public class CrudLong extends CrudNotNullableValue<Long> {
		...
		public CrudLong(final String dbFieldName) {
			super(dbFieldName);
		}
		...
		public void setLong(final long t) {
			this.t = t;
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.getLong(offset + index);
		}
	...
	public class CrudString extends CrudNotNullableObjectValue<String> {
		public CrudString(final String dbFieldName) {
			super(dbFieldName);
			t = "";
		}
		...
		protected void fromCursor(final int offset, final Cursor cursor) {
			if (cursor.isNull(index + offset)) {
				throw new NullPointerException("Value for "
						+ this.getClass().getSimpleName() + " at cursor index "
						+ index + " is null.");
			}
	...
	public class CrudFloat extends CrudNotNullableValue<Float> {
		...
		public CrudFloat(final String dbFieldName) {
			super(dbFieldName);
		}
		...
		public void setFloat(final float t) {
			this.t = t;
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.getFloat(offset + index);
		}
	...
	public class CrudDouble extends CrudNotNullableValue<Double> {
		...
		public CrudDouble(final String dbFieldName) {
			super(dbFieldName);
		}
		...
		public void setDouble(final double t) {
			this.t = t;
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.getDouble(offset + index);
		}
	...
	public class CrudBlob extends CrudNotNullableObjectValue<byte[]> {
		public CrudBlob(final String dbFieldName) {
			super(dbFieldName);
			t = new byte[0];
		}
	...
	public class CrudDate extends CrudNotNullableObjectValue<Date> {
		public CrudDate(final String dbFieldName) {
			super(dbFieldName);
			t = new Date();
		}
		...
		@Override
		protected void addToContentValues(final ContentValues values) {
			values.put(dbFieldName, t.getTime());
		}

		@Override
		public void set(final String s) {
			t = new Date(Long.valueOf(s));
		}

	}

	public class CrudEnum<T extends Enum<T>> extends
			CrudNotNullableObjectValue<T> {
		...
		@Override
		protected void addToContentValues(final ContentValues values) {
			values.put(dbFieldName, t.name());
		}

		@Override
		public void set(final String s) {
			t = Enum.valueOf(clazz, s);
		}
	...
	public class CrudNullableBoolean extends CrudNullableValue<Boolean> {
		public CrudNullableBoolean(final String dbFieldName) {
			super(dbFieldName);
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.isNull(offset + index) ? null : cursor.getInt(offset
					+ index) != 0;
		}

		@Override
		protected void addToContentValues(final ContentValues values) {
			values.put(dbFieldName, t == null ? null : (t ? 1 : 0));
		}

		@Override
		public void set(final String s) {
			t = s == null ? null : Boolean.valueOf(s);
		}

	}

	public class CrudNullableShort extends CrudNullableValue<Short> {
		public CrudNullableShort(final String dbFieldName) {
			super(dbFieldName);
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.isNull(offset + index) ? null : cursor.getShort(offset
					+ index);
		}
		...
		@Override
		public void set(final String s) {
			t = s == null ? null : Short.valueOf(s);
		}
	}

	public class CrudNullableInteger extends CrudNullableValue<Integer> {
		public CrudNullableInteger(final String dbFieldName) {
			super(dbFieldName);
		}
		...
		@Override
		public void set(final String s) {
			t = s == null ? null : Integer.valueOf(s);
		}
	}

	public class CrudNullableLong extends CrudNullableValue<Long> {
		public CrudNullableLong(final String dbFieldName) {
			super(dbFieldName);
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.isNull(offset + index) ? null : cursor.getLong(offset
					+ index);
		}
		...
		@Override
		public void set(final String s) {
			t = s == null ? null : Long.valueOf(s);
		}

	}

	public class CrudNullableString extends CrudNullableValue<String> {
		public CrudNullableString(final String dbFieldName) {
			super(dbFieldName);
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.isNull(offset + index) ? null : cursor.getString(offset
					+ index);
		}
	...
	public class CrudNullableFloat extends CrudNullableValue<Float> {
		public CrudNullableFloat(final String dbFieldName) {
			super(dbFieldName);
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.isNull(offset + index) ? null : cursor.getFloat(offset
					+ index);
		}
		...
		@Override
		public void set(final String s) {
			t = s == null ? null : Float.valueOf(s);
		}

	}

	public class CrudNullableDouble extends CrudNullableValue<Double> {
		public CrudNullableDouble(final String dbFieldName) {
			super(dbFieldName);
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.isNull(offset + index) ? null : cursor.getDouble(offset
					+ index);
		}
		...
		@Override
		public void set(final String s) {
			t = s == null ? null : Double.valueOf(s);
		}

	}

	public class CrudNullableBlob extends CrudNullableValue<byte[]> {
		public CrudNullableBlob(final String dbFieldName) {
			super(dbFieldName);
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.isNull(offset + index) ? null : cursor.getBlob(offset
					+ index);
		}
		...
		@Override
		public void set(final String s) {
			t = s == null ? null : s.getBytes();
		}

	}

	public class CrudNullableDate extends CrudNullableValue<Date> {
		public CrudNullableDate(final String dbFieldName) {
			super(dbFieldName);
		}

		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.isNull(offset + index) ? null : new Date(
					cursor.getLong(offset + index));
		}

		@Override
		protected void addToContentValues(final ContentValues values) {
			values.put(dbFieldName, t == null ? null : t.getTime());
		}

		@Override
		public void set(final String s) {
			t = s == null ? null : new Date(Long.valueOf(s));
		}

	}

	public class CrudNullableEnum<T extends Enum<T>> extends
			CrudNullableValue<T> {
		private final Class<T> clazz;

		public CrudNullableEnum(final String dbFieldName, final Class<T> clazz) {
			super(dbFieldName);
			this.clazz = clazz;
		}
		...
		@Override
		protected void fromCursor(final int offset, final Cursor cursor) {
			t = cursor.isNull(offset + index) ? null : Enum.valueOf(clazz,
					cursor.getString(offset + index));
		}

		@Override
		protected void addToContentValues(final ContentValues values) {
			values.put(dbFieldName, t == null ? null : t.name());
		}

		@Override
		public void set(final String s) {
			t = s == null ? null : Enum.valueOf(clazz, s);
		}
	...
	/**
	 * @param valueCount
	 *            the number of values expected for this crud instance
	 *            (excluding the _id field) set this to the correct value
	 *            initially to avoid resizing of the internal list holding the
	 *            members
	 */
	public Cruddable(final String tableName, final String authority,
			final int valueCount) {
		this(tableName, authority, valueCount, true);
	}
	 ...
	 *            members
	 * @param hasId
	 * 			  whether the table has an _id column. Usually true. If false, creating, updating and deleting 
	 * 			  values will cause exceptions, so this should only be set to false for read-only access to tables or views.
	 */
	public Cruddable(final String tableName, final String authority,
			final int valueCount, final boolean hasId) {
		values = new ArrayList<CrudValue<?>>(hasId ? valueCount + 1 : valueCount);
	...
	/**
	 * simple query by id, sets the values of this instance to the values of the
	 * row with the given id.
	 * 
	 * @param resolver
	 *            not null
	 * @param _id
	 *            the id of the row to use
	 * @throws IllegalArgumentException
	 *             if the id was not found in the database
	 */
	public void query(final ContentResolver resolver, final long _id) {
		final Cursor cursor = resolver.query(
				UriUtils.appendToUri(getBaseUri(), _id), getProjection(), null,
				null, null);
		try {
	...
	/**
	 * Sets this instances' values with the values found in the cursor at the
	 * cursor's current position
	 * 
	 * @param cursor
	 *            not null, must be positioned at a valid row
	 */
	...
	/**
	 * Sets this instances' values with the values found in the cursor at the
	 * cursor's current position. The fields are queried from the given cursor
	 * with the given offset. Use this for queries spanning multiple tables.
	 * 
	 * @param offset
	 *            the offset into the field indices, must be >= 0
	 * @param cursor
	 *            not null, must be positioned at a valid row
	 */
	...
	/**
	 * Reads the given cruddables from the given cursor in the order in which
	 * they are listed as arguments. Takes care of the correct offsets for each
	 * cruddable. Use this for queries spanning multiple tables.
	 * 
	 * @param cursor
	 *            not null, must be positioned at a valid row
	 * @param cruddables
	 *            the cruddables to fill from the current row
	 */
	public static void fromCursor(final Cursor cursor,
			final Cruddable... cruddables) {
		fromCursor(0, cursor, cruddables);
	}

	public static void fromCursor(final int offset, final Cursor cursor,
			final Cruddable... cruddables) {
	...
	/**
	 * Creates a new db entry with the current values, sets the id to the id of
	 * the new entry.
	 * 
	 * @param resolver
	 *            resolver to use for accessing the db, not null
	...
	public Long create(final ContentResolver resolver) {
		...
		try {
			...
			throw new IllegalArgumentException("Could not read id from uri: "
					+ uri);
		}
		return _id.get();
	}
	 ...
	 * 
	 * @param db
	 *            the db to insert the row in, not null
	 */
	 ...
	 *            resolver to use for accessing the db, not null
	 * @throws IllegalArgumentException
	 *             if the current id is null or if more than one row was updated
	 */
	public void update(final ContentResolver resolver) {
		if (_id.isNull()) {
			throw new IllegalStateException("Cannot update " + this
					+ ", id is null.");
		}
	 ...
	 * 
	 * @param db
	 *            the database to update in, not null
	 * @throws IllegalArgumentException
	 *             if the current id is null or if more than one row was updated
	 */
	public void update(final SQLiteDatabase db) {
		...
		final int count = db.update(tableName, toContentValues(), "WHERE " + ID
	...
	/**
	 * Depending on whether the id of this Cruddable is set, either creates or
	 * updates a row through the given content resolver.
	 * 
	 * @param resolver
	 *            resolver to use for accessing the db, not null
	 */
	...
	public void delete(final ContentResolver resolver) {
		...
		resolver.delete(UriUtils.appendToUri(getBaseUri(), _id.get()), null,
				null);
	}
	 ...
	 * 
	 * @param db
	 *            the database to delete the entry in, not null
	 * @throws IllegalStateException
	 *             if the current id is null
	 */
	public void delete(final SQLiteDatabase db) {
		...
		db.delete(tableName, "WHERE " + ID + "=?", new String[] { _id.get()
				.toString() });
	}

	/**
	 * @return the projection (array of column names) for this Cruddable, has at
	 *         least length 1
	 */
	...
	/**
	 * @param tablePrefix
	 *            identifier to prefix to the column names. Without the ".". So
	 *            if you want the field "_id" to be returned as "foo._id", pass
	 *            in "foo"
	...
	/**
	 * Combines the given arrays into one. Use this to create a projection for a
